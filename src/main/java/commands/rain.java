...
public class rain implements CommandExecutor {
    ...
    public rain(DynamicAtmosphere plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player || sender instanceof ConsoleCommandSender) {
            // Verificar permisos
            if (sender.hasPermission("dynamicAt.rain") || sender instanceof ConsoleCommandSender || sender.isOp()) {
                ...
                timeSetMessage = timeSetMessage.replace("%dy-time-en%", "rainy");
                timeSetMessage = timeSetMessage.replace("%dy-time-es%", "lluvioso");
